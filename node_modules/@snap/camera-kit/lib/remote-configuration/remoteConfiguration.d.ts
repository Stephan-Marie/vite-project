...
import { GetInitializationConfigResponse, MetricsDefinition } from "../generated-proto/pb_schema/camera_kit/v3/service";
import { GrpcHandler } from "../clients/grpcHandler";
import { TsProtoServiceClient } from "../clients/createTsProtoClient";
...
export declare class RemoteConfiguration {
    ...
    constructor(lensPerformance: CameraKitConfiguration["lensPerformance"], cofHandler: ReturnType<typeof cofHandlerFactory>, grpcClient: TsProtoServiceClient<typeof MetricsDefinition>);
    /**
     * COF configuration.
     */
...
export declare const remoteConfigurationFactory: {
    ...
    }>, args_2: GrpcHandler): RemoteConfiguration;
